...
//                    Latency("Running Processes", 75);
    ...
    private void Latency(String ServerChoice, int numClients)
    {
        ...
        //start time for all Client processing
        long clientCreationNProcessTimeStart = System.nanoTime(); 
        try 
        {    
            String serverResponse = ServerConnect.serverResponse(ServerChoice, "Server: ", true);
            
            //start time for all clients to be created
            long allClientsCreationStartTime = System.nanoTime();
            ...
            //end time for all clients to be created
            long allClientsCreationEndTime = System.nanoTime();
            //total time for all clients to be created
            long totalAllClientsCreationTime = (allClientsCreationEndTime - allClientsCreationStartTime);
            ...
            for(int x = 0; x < numClients; x++) 
            {                   
                long indivClientRequestProcessTime = (clients[x].endTime/1000);
                ...
                System.out.println("Client " + (x + 1) + " request processed in: " + indivClientRequestProcessTime + " microseconds");
            }
            
            long clientCreationNProcessTimeEnd = System.nanoTime(); 
            long totalClientCreationNProcessTime = ((clientCreationNProcessTimeEnd - clientCreationNProcessTimeStart)/1000);
            long medianResponseTime = (totalClientCreationNProcessTime/numClients);
            ...
            System.out.println("------------------------");
            System.out.println("     Time to create all Clients:                 " + totalAllClientsCreationTime + " microseconds");
            System.out.println("--------------------------------------------------------------------------------------------");
            System.out.println("     Total request & process completion time:    " + totalClientCreationNProcessTime + " microseconds");
            System.out.println("--------------------------------------------------------------------------------------------");
            System.out.println("     Median request & process completion time:   " + medianResponseTime + " microseconds");
            System.out.println("********************************************************************************************");
            System.out.println();
            System.out.println();
